...
public class SinkWeightedMovingAverageMobilityEvaluation<N extends Node> extends LinearStandardization {

    MobilityModel mobilityModel;

    public SinkWeightedMovingAverageMobilityEvaluation(DoubleScope scoreScope, double weight,
	    MobilityModel mobilityModel) {
