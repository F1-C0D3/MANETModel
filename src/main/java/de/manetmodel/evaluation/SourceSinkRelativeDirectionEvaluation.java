...
public class SourceSinkRelativeDirectionEvaluation<N extends Node, L extends Link<W>, W extends LinkQuality> extends LinearStandardization {

    MobilityModel mobilityModel;

    public SourceSinkRelativeDirectionEvaluation(DoubleScope scoreScope, double weight, MobilityModel mobilityModel) {
